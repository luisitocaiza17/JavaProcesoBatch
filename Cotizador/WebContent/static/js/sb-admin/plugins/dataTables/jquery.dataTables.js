...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="'+classes.sFilterInput+'" style="width:800px;margin-top:5px;font-size:14px;" placeholder="Escriba la palabra a buscar..."/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Mostrando  _START_ a _END_ de ( _TOTAL_ ) Cotizaciones",
