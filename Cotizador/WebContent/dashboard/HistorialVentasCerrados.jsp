	    	 ...
	    	 $('#ConsultaBtn').click(function(){
				...
				//Metodo validacion de fechas buscador
					...
					function actualizar(event) {
						...
						if($(target).parent().prev().prev().prev().prev().prev().text() == "Vehiculos Livianos")
							window.open('Cotizacion.jsp?id='+id);
						
						if($(target).parent().prev().prev().prev().prev().prev().text() == "Vehiculos Cerrados Livianos")
							window.open('CotizacionLivianos.jsp?id='+id);							
						
						if($(target).parent().prev().prev().prev().prev().prev().text() == "Vehiculos Cerrados Motos")
							window.open('CotizacionMotos.jsp?id='+id);
						
						if($(target).parent().prev().prev().prev().prev().prev().text() == "Vehiculos Cerrados Pesados")
							window.open('CotizacionPesados.jsp?id='+id); 
						
						if($(target).parent().prev().prev().prev().prev().prev().text() == "Vehiculos Cerrados Publicos")
							window.open('CotizacionPublicos.jsp?id='+id);
						}
