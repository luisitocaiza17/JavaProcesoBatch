	...
	<div class="content">
		...
		<form id="wizard" action="" method="post">
            ...
            ************************************************************************************************-->
			...
			<a id="agregarVehiculonumero"  class="btn btn-primary glyphicon glyphicon-plus datosVehiculo fondo_botones" onclick="agregarVehiculo(); $('#guardarVehiculo'+(Number($('#numero_vehiculos').val())-1)).click()">Agregar un nuevo vehículo</a> 
