...
<!-- 	<link rel="stylesheet" type="text/css" href="../static/css/jquery-ui.theme.css" /> -->
	...
	var QueryString;
					...
					var cotizacionesEspeciales = [ '523', '653', '702', '879',
							'1102', '1143', '1215', '1503', '1805', '1860',
							'2548', '2736', '2757', '2894', '3098', '3332',
							'3505', '3540', '3545', '3649', '3814', '4186',
							'4278', '4313', '4427', '4546', '4597', '4636',
							'4745', '4850', '4952', '5373', '5375', '5407',
							'5533', '5598', '5968', '6035', '6173', '6227',
							'6329', '6559', '6682', '6719', '6848', '6919',
							'7002', '7013', '7019', '7367' ];
		                ...
		                <input type="hidden" id="necesitaInspeccion" name="necesitaInspeccion" value="false">
							...
							<table>
							  ...
							  <tr>
							    ...
							    <td colspan="3"><select name="agentes" id="agentes" class="datosVehiculo" onchange="obtenerAgenteComision();" required="required"></select></td>
							  </tr>
							   <tr>
							    <td><label><b>Comisi&oacute;n del agente (%):*</b></label></td>
							    <td><input type="text" id="porc_comision" name="porc_comision" readonly onkeypress="return justNumbers(event);" onblur="validarRangoComisionMLDealer();"><select hidden="hidden" id="porc_comision_cb" name="porc_comision_cb" onchange="$('#porc_comision').val($('#porc_comision_cb').val());" required="required" readonly></select></td>
							    <td colspan="2"></td>
							  </tr>
						</table>																	
								</div> 
