					...
					<div class="panel-body">
						...
						<table >
							...
							<ul class="nav nav-tabs">
								...
								<li><a href="#segundo" data-toggle="tab" id="tabInspecciones" class="mostrarFuncionalidad">Solicitar
										Inspección</a></li>
								<li  id="linkDescuentos"><a href="#tercero" data-toggle="tab" class="mostrarFuncionalidad">Solicitud de
										Descuentos</a></li>
